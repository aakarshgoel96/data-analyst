...
ggplot(data = df,
       aes(x = pH, y = total_acidity, color = quality.factor)) +
  geom_point() +
  facet_wrap(~review)+
  stat_smooth(method="lm", se=FALSE)
...
Above plots show that volatile acidity is very negatively correlated with quality and other positive factors. Volatile acidity makes not only quality of beer low but affects citric acid, alcohol, sulphates and many otherpositive features. correlation b/w citric acid and volatile acidity is -0.55 which affects it a lot.
